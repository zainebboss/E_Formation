 ...
 */
final class Version20210419213350 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, formateur_id INT NOT NULL, apprenant_id INT NOT NULL, note INT NOT NULL, INDEX formateur_id (formateur_id), INDEX apprenant_id (apprenant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = MyISAM COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, formation_id INT NOT NULL, date_inscrit DATE NOT NULL, INDEX id_apprenant (utilisateur_id), INDEX id_formation (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = MyISAM COMMENT = \'\' ');
